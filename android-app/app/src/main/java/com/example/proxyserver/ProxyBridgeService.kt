...
class ProxyBridgeService : Service() {
    ...
    private fun scheduleRestart() {
        ...
        val restartIntent = Intent(applicationContext, ProxyBridgeService::class.java)
        val immutableFlag = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) PendingIntent.FLAG_IMMUTABLE else 0
        val flags = PendingIntent.FLAG_ONE_SHOT or PendingIntent.FLAG_CANCEL_CURRENT or immutableFlag
